<template>
  <section class="mx-6 mt-24 mb-8 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
    <div class="space-y-3">
      <div>
    ...
    <div class="mt-4 overflow-x-auto rounded-xl border border-slate-200 dark:border-slate-700">
      <table class="min-w-full divide-y divide-slate-200 text-sm dark:divide-slate-700">
        ...
        <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
          <tr v-if="loading">
            <td colspan="8" class="px-3 py-8 text-center text-slate-500 dark:text-slate-400">Loading draft orders...</td>
          </tr>
          <tr v-else-if="!orders.length">
            <td colspan="8" class="px-3 py-8 text-center text-slate-500 dark:text-slate-400">No draft orders found.</td>
          </tr>
